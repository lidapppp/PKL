...
class Portofolio extends BaseController
{
    ...
    public function fetch_data()
    {
        ...
        if ($request->isAJAX()) {
            $msg = [
                'data' => view('admin/portofolio/read')
            ];
    ...
    public function form_tambah()
    {
        ...
        if ($request->isAJAX()) {
            ...
            $msg = [
                'data' => view('admin/portofolio/create')
            ];
    ...
    public function form_edit()
    {
        ...
        if ($request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('admin/portofolio/update')
            ];
    ...
    public function show_detail()
    {
        ...
        if ($request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('admin/portofolio/detail')
            ];
