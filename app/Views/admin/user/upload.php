    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Upload Foto User</h5>
            ...
            <br>
            <center>
                <img class="img-thumbnail img-preview" width="70%" src="<?= base_url('uploads/user') . '/' . $foto; ?>" alt="Foto User">
            </center>
            <div class="modal-body">
                ...
                <div class="div-col-sm-9 mb-3">
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="foto">Foto User</label>
